# STATE.md — Pre-Partition Snapshot (2026-04-17)

This file is a reference snapshot of the operational/technical
content that lived in STATE.md before the 2026-04-17 split.

On 2026-04-17, STATE.md was partitioned: strategic state (live
counts, distribution layer, milestones) stayed in STATE.md;
operational state (deploy hashes, framework versions, deploy
commands, script invocations) moved here.

The content below reflects the pre-split operational surface. It
is kept for reference only. Current operational state should live
in the relevant operational repo's own STATE.md (e.g.,
~/Projects/com/STATE.md when one is created) — not here.
...
## Active Month Group (retired — was Mintlify docs.json)

Current month group for new briefs (at the time of this snapshot): **April 2026**

This routing existed for the Mintlify docs.json nav. Mintlify was retired April 2026; briefs now live at `~/Projects/com/src/content/briefs/` and are auto-discovered by Astro Content Collections. No nav file to update.
